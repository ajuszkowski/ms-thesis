...
\title{Automated Analysis of Weak Memory Models}

% A subtitle is optional and this may be deleted
%\subtitle{Optional Subtitle}
\author{Artem Yushkovskiy\inst{1,2} \\ 
{\scriptsize MSc Candidate}
\\ \vspace{1em}
{\footnotesize\raggedleft Supervisors: Assoc. Prof. Keijo Heljanko\inst{1} \newline
\hphantom{Supervis} Docent Igor I. Komarov\inst{2} }
}%\small
