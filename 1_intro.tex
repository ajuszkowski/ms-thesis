...
Weakened guarantees (such as memory operations reordering, write buffering, etc.) are called \textit{relaxations} of the memory model.
...
Thus, WMMs serve as set of guarantees made by designers of an execution environment to programmers on which behaviours of their concurrent code they can rely on.
