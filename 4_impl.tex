...
%
by Microsoft Research~\cite{de2008z3}. However, unlike its predecessor, the \porthos[2] has an additional abstraction level, \zformula{} (see Section~\ref{ch:impl:model:zformula}), that allows the use any other SMT-solver.
...
Thirdly, the grammar used by \porthos{} allowed only a small set of operations.
...
The first internal representation used by \porthos[2] is the \textit{\ytree{}}, which represents a high-level AST.
