...
<todo: enumerate elements>

<carries the origin -- from cat file>
...
Following the structure of a Z3-formula, the atomic elements of a \zformula{} are variables, and the expressions are 

reference to Z3-tutorial AND 

All expressions and variables of a \zformula{} are typed.
Basically, we distinguish \textit{boolean} and \textit{numeric} (integer, floating point, <else?>) data type
...
<TODO: SAY MORE: validation of ht einput elements during construction, maybe verif after building>
