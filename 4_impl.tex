...
firstly, in order to be able to reuse some parts and concepts of \porthos{} also written in Java, and secondly, because the authors find the concepts of Object-Oriented Programming~(OOP) in Java suitable for modelling languages.
...
%TODO: ATTENTION HERE TO THE PICTURE!!!!!!!!!!!!!!!!!!!!!!!!
\begin{figure}[H]
  \centering
  \includegraphics[height=.95\textheight,keepaspectratio]{img/my/draw.io/general_arch-no_numbering.png}
