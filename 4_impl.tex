...
%process more intricate entities of the C language. 
%Extension of the input language imply not only ability to process syntactic sugar
...
\section{Architecture} %Program Components
\label{ch:impl:arch}
