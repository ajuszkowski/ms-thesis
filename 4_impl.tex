...
<TODO: in picture change: xmemorymaager belongs to the program interpreter!>
...
We distinguish three types of processes (each implement the \texttt{XInterpreter} interface):
