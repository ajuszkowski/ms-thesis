...
- carries the origin (text) -> all the origins can be resolved by the \texttt{LocationService} %todo: rename from CodeCitationService + create 3 instances for each of level. Or keep it for Y->text, and store references to the original Y-object by X-objects
