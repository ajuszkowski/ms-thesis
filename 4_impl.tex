...
\begin{figure}[H]
  \centering
  %draft=true
  \includegraphics[height=.83\textheight,keepaspectratio]{img/my/draw.io/general_arch-no_numbering.png} %{img/my/draw.io/general_arch.png}
   ...
   switch (functionName) {
     case "WRITE_ONCE": {
       return new XInvocationHookAction((receiver, arguments) -> {
         ...
         XSharedLvalueMemoryUnit dest = (XSharedLvalueMemoryUnit) destUnit;
