...
Secondly, in \porthos[1], the semantics of operations was defined syntactically (in \tool{ANTLR} grammar), whereas this should be performed by a separate module operating on the AST level%
...
The It is a complex processing unit, Figure~\ref{fig:compiler} illustrates the relationship between the principal components of the X-compiler in the UML language.
