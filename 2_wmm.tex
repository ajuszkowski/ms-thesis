...
New relations can be defined via the keyword \texttt{let} and the following operations over relations~\cite{alglave2016syntax}: % 3.1.6 Relations between events
...
Figure~\ref{example:x86-cat} contains part of x86-TSO model~\cite{owens2009better} that asserts acyclicity of communication relation and \rel{po-loc} relation:
