...
\usepackage{listings}
\renewcommand{\lstlistingname}{Figure}  %perhaps, it's not a gute Idee to change all the listings to Figures
...
\newcommand{\ytree}{\ensuremath{\mathtt{Y\text{-}tree}}}
\newcommand{\xgraph}[1][]{\ensuremath{\mathtt{X\text{-}graph
\ifthenelse%
{\equal{#1}{}}%if
{}%then
{_{#1}}%else
}}}
\newcommand{\xgraphU}[1][]{\ensuremath{\mathtt{X\text{-}graph%unrolled x-graph
\ifthenelse%
{\equal{#1}{}}%if
{}%then
{_{#1}^u}%else
}}}
\newcommand{\wmodel}{\ensuremath{\mathtt{W\text{-}model}}}
\newcommand{\zformula}{\ensuremath{\mathtt{Z\text{-}formula}}}
...
\titleformat{\paragraph}[display]%[runin]
