...
First of all, I wish to thank Professor Keijo Heljanko for his continuous support in both technical and moral sides of the work.
He has opened for me the opportunity of working in this extremely interesting project; he has been guiding and assisting me during six months, explaining all the things I don't understand and helping to find the way when I have lost it.
...
\input{91_apx_trees.tex}
\input{92_apx_hook.tex}
\input{93_apx_y2xconverter.tex}
\input{94_apx_interpreter.tex}
\input{95_apx_dekker.tex}
\input{96_apx_output.tex}
